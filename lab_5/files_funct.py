...
class FilesFunct:
    ...
    def serialization_rsa_public_key(public_key: rsa.RSAPublicKey, public_pem: str) -> None:
        ...
        try:
            ...
            print(
                f"Произошла ошибка при сериализации открытого ключа в файл pem: {e}")
    ...
    def serialization_rsa_private_key(
        ...
        try:
            ...
            print(
                f"Произошла ошибка при сериализации закрытого ключа в файл: {e}")
    ...
    def serial_sym_key(file_name: str, key: bytes) -> None:
        ...
        try:
            ...
            print(
                f"Произошла ошибка при сериализации симметричного ключа в файл: {e}")
    ...
    def deserial_sym_key(file_name: str) -> bytes:
        ...
        try:
            ...
            print(
                f"Произошла ошибка при десериализации симметричного ключа: {e}")
            return None
