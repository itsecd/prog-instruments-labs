...
class GuessTheNumber:
    def __init__(self):
        self.numberToGuess = random.randint(-100, 100)  # Изменено на диапазон от -100 до 100
        self.attempts = 0
    ...
    def checkGuess(self, guess):
        ...
        if difference == 0:
            print(f"Поздравляем! Вы угадали число {self.numberToGuess} за {self.attempts} попыток.")
        elif difference <= 5:
