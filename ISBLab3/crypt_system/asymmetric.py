...
class Asymmetric:
    ...
    def asymmetrical_keygen() -> tuple:
        ...
        log.info("generate private key (asymmetrical)")
        public_key = private_key.public_key()
        log.info("generate public key (asymmetrical)")
    ...
    def symmetrical_key_encryptor(
        ...
        log.info("generate encrypted symmetric key")
        return ciphertext
    ...
    def symmetrical_key_decryptor(
        ...
        log.info("key decrypted by asymmetrical algorithm")
