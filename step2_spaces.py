...
class Char:
  def __init__(self, name, hp_value, atk_value, def_value):
    self.name = name; self.hp = hp_value; self.attack = atk_value; self.defense = def_value; self.alive = True
...
def team_battle(teamA, teamB):
    ...
    living1 = sum(1 for f in teamA if f.is_alive());living2 = sum(1 for f in teamB if f.is_alive())
...
def train(ch, rounds = 5):
 for i in range(rounds):
   dummy = Char("Dum", 50, 0, 0); basic_attack(ch, dummy)
   if dummy.is_alive():ch.do_attack(dummy)

def arena(size = 3):
 team1 = make_team(size);team2 = make_team(size)
 print("T1:") ; print(rep(team1)) ; print("T2:") ; print(rep(team2))
 w = team_battle(team1, team2); print("Winner:", w)
...
def menu():
    ...
    print("1.Duel");print("2.Team");print("3.tournament");print("4.survive");print("5.quest")
    ch = input("Select: ")
    if ch=="1":
        f1 = Warr("Hero");f2 = Mag("Villain")
        w = simulate_duel(f1, f2);print("Winner:", w.name)
    elif ch=="2": arena()
...
def util_func_6():print('util6');return 6
...
def util_func_12():print('util12');return 12
...
def util_func_18():print('util18');return 18
...
def util_func_24():print('util24');return 24
...
def util_func_30():print('util30');return 30
...
def util_func_36():print('util36');return 36
...
def util_func_42():print('util42');return 42
...
def util_func_48():print('util48');return 48
...
def util_func_54():print('util54');return 54
...
def util_func_60():print('util60');return 60
...
def util_func_66():print('util66');return 66
...
def util_func_72():print('util72');return 72
...
def util_func_78():print('util78');return 78
...
def util_func_84():print('util84');return 84
...
def util_func_90():print('util90');return 90
...
def util_func_96():print('util96');return 96
